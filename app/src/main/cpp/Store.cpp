//
// Created by Olga Papkovskaya on 6/22/17.
//
#include <jni.h>
#include <string>
...
Java_com_papkovskaya_olga_myndkapplication_Store_getCount(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_papkovskaya_olga_myndkapplication_Store_getString(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_getInteger(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_getFloat(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_getBoolean(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_getShort(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_getDouble(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_getLong(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_getByte(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
Java_com_papkovskaya_olga_myndkapplication_Store_setString(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jstring pString) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setInteger(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jint pInteger) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setObject(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jobject pObject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setFloat(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jfloat pFloat) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setShort(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jshort pShort) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setLong(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jlong pLong) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setDouble(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jdouble pDouble) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setByte(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jbyte pByte) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_setBoolean(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey,
        jboolean pBoolean) {
...
Java_com_papkovskaya_olga_myndkapplication_Store_getObject(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_papkovskaya_olga_myndkapplication_Store_hasEntry(
        JNIEnv* pEnv,
        jobject pThis,
        jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
